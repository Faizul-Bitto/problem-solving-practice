...
int main()
{
    ...
    while (T--)
    {
        ...
        long long int multiplicationOfRestThreeValues = (A * B * C);

        if (multiplicationOfRestThreeValues == 0)
        {
            if (M == 0)
            {
                printf("0\n");
        ...
        if (M % multiplicationOfRestThreeValues != 0)
        {
            printf("-1\n");
        }
        else
        {
            long long int missingNumber = (M / multiplicationOfRestThreeValues);
            if (missingNumber < 0)
            {
                printf("-1\n");
            }
